%% Assignment 1: Part 3
%
% The final stage of the assignment involved adding in two square regions
% that bottle neck the movement of the particles. Handling the regions
% involved ensuring no particles were spawned within the regions and
% defining each edge of the boxes as a border. The particles would bounce
% of the regions, similar to how they were to bounce off the top of the
% region. The simulation result can be found below. 
...
%%
% Temperature and electron density maps were then developed for the
% regions. The plots can be seen below. The noteable result is that there
% are no traces of electrons in the boxed regions. The temperature density
% is related to the random scatter and distribution still occuring in the
% region, hence the non-uniformity in the points. 
